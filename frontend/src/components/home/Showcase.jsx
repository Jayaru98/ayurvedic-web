...
import Image1 from '../../assets/Images/showcase/show_1.png'
import Image2 from '../../assets/Images/showcase/showcase-2.jpg'
import Image4 from '../../assets/Images/showcase/process_3.webp'
import Image3 from '../../assets/Images/showcase/show_2.png'
import Image5 from '../../assets/Images/showcase/pro.png'
    ...
    <div className='min-h-screen bg-amber-50'>
        ...
        <div className="container mx-auto pb-16">
          <div className="text-center mb-6 md:mb-16" data-aos="fade-up" data-aos-delay="400">
            ...
            <span className='block md:hidden text-[16px] font-medium font-sans text-[#696969]'>At Nature Foot Care & Ayurvedic Wellness, every treatment is a journey of relaxation and healing. Rooted in Ayurveda and nature, our spa offers a serene escape to restore balance, energy, and inner peace</span>
          </div>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:ml-36 md:mr-36'>
            ...
            <div className='mx-auto'>
             ...
             <div className='mx-auto'>
                <img src={Image5} alt="" className='w-[320px] h-[300px] md:w-[250px] md:h-[380.61px] lg:w-[403px] lg:h-[480.42px] rounded-2xl transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 object-bottom' data-aos="fade-up" data-aos-delay="500"/>
            </div>
          </div>
        </div>
    </div>
