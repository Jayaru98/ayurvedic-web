        ...
        <div className="container mx-auto pb-0 pt-0 md:pt-8">
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:ml-36 md:mr-36'>
            <div className='mx-auto'>
                ...
                <img src={Image2} alt="" className='w-[320px] h-[250px] md:w-[320px] md:h-[250px] lg:w-[403.33px] lg:h-[250.33px] rounded-2xl mb-8 transition-transform duration-300 hover:shadow-lg hover:-translate-y-1' data-aos="fade-up" data-aos-delay="400"/>
            </div>
            <div className='mx-auto'>
