    ...
    <div className='bg-[#1D4026] md:pb-6' data-aos="fade-up" data-aos-delay="100">
        <div className='flex justify-between items-center p-4 md:p-6 md:ml-28 mr-28'>
            ...
            <div className="hidden md:flex items-center space-x-4" >
                {/* Social Media Icons */}
                <a href="https://www.facebook.com/profile.php?id=61560584634925&mibextid=ZbWKwL" className="text-white border border-white rounded-full p-2 hover:text-black hover:bg-white" data-aos="fade-up" data-aos-delay="400">
                    <FaFacebookF className=''/>
                </a>
                <a href="https://www.instagram.com/footcareayurveda?igsh=MXZ4bmtlYmZqaXF0cg==" className="text-white hover:text-black border border-white rounded-full p-2 hover:bg-white" data-aos="fade-up" data-aos-delay="500">
        ...
        <hr className='hidden md:block border-white/60 border-[0.1px] w-[calc(100% - 64px)] ml-28 mr-28 -mt-4 -mb-4' />
