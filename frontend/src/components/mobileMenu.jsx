  ...
  return (
    <>
        ...
        {/* <div className="md:hidden text-white z-20"> */}
         <div className="md:hidden">
            <button 
                ...
                className={`z-20 hover:text-teal-200 focus:outline-none transition-color duration-200 ${isMenuOpen ? 'fixed top-4 right-6 text-white' : 'absolute top-8 right-6 text-white'}`}
            > 
        ...
        {isMenuOpen && (
            ...
            <div className='md:hidden fixed top-0 h-full pt-40  left-0 right-0 bg-green-900 z-50 animate-drop-in flex flex-col justify-start items-center'>
