...
const NatureFootCare = () => {
  ...
  return (
    <div className="bg-amber-50 ">
      <div
        className="pl-4 md:pl-40 text-[#6B9A75]  md:pt-24"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <p className="flex">
      ...
      <div className="container mx-auto px-4">
        <div
          ...
          data-aos-delay="400"
        >
          <h1 className="text-[32px] md:text-[56px] md:pl-36 text-[#112025]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 ml-6 mr-6 md:ml-40 md:mr-32">
        ...
        <div className="max-w-4xl mx-auto mb-16 ">
          <div
            className="border-b border-[#696969] pl-4 py-4 rounded-xl shadow-md p-8 bg-white"
            data-aos="fade-up"
            data-aos-delay="400"
          >
        ...
        {/* Packages Section */}
        <div
          className="max-w-4xl mx-auto bg-white mb-10"
          data-aos="fade-up"
          data-aos-delay="400"
        >
          <div className="border-l-4 border-[#696969] pl-4 py-2 rounded-xl shadow-md p-8">
            <h2
              className="text-2xl font-bold text-[#112015] mb-6 pb-2 border-b border-[#6B9A75]"
              data-aos="fade-up"
              data-aos-delay="400"
            >
              Packages
